...
occupancy slots (`sim-core/src/grid.rs:5-7`). The baseline width is 100, hence
10,000 slots, and it requests 500 founders (`sim-config/config.toml:1-5`).
...
(`docs/solver-dependent-ecology-route.md:578-613`).
