...
pub fn inspect(ctx: &ReadCtx, args: &[&str], out: &mut impl Write) -> Result<()> {
    ...
    if fmt.is_json() {
        ...
        let value = json!({
            ...
            "genome": {
                ...
                "fast_weight_retention": o.genome.plasticity.fast_weight_retention,
                "action_temperature_scale": o.genome.plasticity.action_temperature_scale,
    ...
    writeln!(
        out,
        "  genome: num_neurons={} synapses={} | initial_learning_rate={:.4} juv_scale={:.3} elig_ret={:.3} fast_ret={:.3} temp={:.3} max_dw={:.4} prune={:.4} | plasticity_maturity={}",
        g.hidden_node_count(),
        o.brain.synapse_count,
        g.plasticity.initial_learning_rate,
        g.plasticity.juvenile_eta_scale,
        g.plasticity.eligibility_retention,
        g.plasticity.fast_weight_retention,
        g.plasticity.action_temperature_scale,
