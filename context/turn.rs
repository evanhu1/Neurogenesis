...
impl Simulation {
    ...
    fn commit_phase(
        ...
        for idx in 0..self.organisms.len() {
            ...
            self.reward_ledgers[idx].record(RewardEvent::DamageTaken {
                energy: spike_damage,
            });

            if organism.health <= 0.0 {
                dead_organisms[idx] = true;
                ...
                if let Some(corpse) = self.spawn_corpse_at_cell(cell_idx, corpse_energy) {
