...
./target/release/sim-cli procedural-ecology-stage0 \
  ...
  --plant-energy 10 \
  --out-dir artifacts/research/runs/completed/open-ended/procedural-ecology-stage0-final-v2
...
./target/release/sim-cli procedural-ecology-stage0 \
  ...
  --release-interval 100 \
  --plant-energy 10 \
  --out-dir artifacts/research/runs/completed/open-ended/procedural-ecology-stage0-final-v2-replay
```
...
Replay artifact:
`artifacts/research/runs/completed/open-ended/procedural-ecology-stage0-final-v2-replay/procedural-ecology-stage0-1783943744923-31416.json`.
...
`research/archive/reports/open-endedness-finiteness-audit.md`.
