...
const ORGANISM_RADIUS_SCALE = 0.48;
const ORGANISM_PICK_RADIUS_SCALE = 0.42;
const ORGANISM_TAIL_LENGTH_SCALE = 0.7;
const ORGANISM_SIDE_SPAN_SCALE = 0.54;
const FOCUSED_ORGANISM_STROKE_SCALE = 0.08;
const FOCUSED_ORGANISM_MIN_STROKE_PX = 0.7;
const ORGANISM_STROKE_SCALE = 0.025;
const ORGANISM_MIN_STROKE_PX = 0.35;
